...
Auto-Order è un'applicazione "liquida" in grado di conformarsi agli standard di settore, e adeguarsi alle procedure aziendali di controllo e monitoraggio: oltre 140 connettori disponibili - certificati e validati - verso ambienti gestionali e di gestione documentale.`,
    },
    {
        name: "Umes",
...
classificare la documentazione sfruttando algoritmi che analizzano la grafica del documento e la presenza di parole chiave;
Definire le "Business Rules Hedging";
Gestire le logiche di ranking e profitability del borrower;
Identificare l'importo dello specifico debito e relative posizioni ipotecarie;
esportare dati e informazioni verso altri sistemi gestionali`,
    ...
    },
    {
        ...
        description2: `Lend Manager è una soluzione software che semplifica la gestione dei documenti necessari per la valutazione di richieste di finanziamento. L'applicazione classifica ed estrae le informazioni necessarie dai documenti ricevuti (.pdf, .doc, .jpg, etc.), effettua la validazione delle pratiche, ed esegue tutte le verifiche necessarie per l’evasione del documento, monitorando ogni operazione e notificando l’esito.
Lend Manager è predisposto per l'integrazione con i sistemi degli istituti creditizi.`,
    },
    {
        name: "Sickness",
        img: "",
...
Pelly è progettato anche per controllare e monitorare lo stato delle forniture`,
    },
    {
        name: "Folder Manager",
        img: "",
...
L'applicazione è completa di interfaccie web - desktop e mobile - che permettono di comporre viste e filtrare i dati secondo le esigenze aziendali`
    },
    {
